            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price"><%=product.getDiscount()%>% 할인! <span>$<%=product.getPrice() %></span></div>
                                    ...
                                    <div class="size__btn">
                                    	...
                                    	<%for(int i =0; i< product.getSizeList().size(); i++){ %>
                                          <label for="xs-btn" class="active">
                                            ...
                                            <%=product.getSizeList().get(i).getSize().getSize_name() %>
                                        </label>
                                        <%} %>
